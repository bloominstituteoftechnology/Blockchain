...
def mine():
    ...
    if not data['proof'] or not data['id']:
        ...
        error_response = {
            "message": "Request is missing either a proof or id"
        }
...
def handle_transaction():
    ...
    if not data['sender'] or not data['amount'] or not data['recepient']:
        ...
        index = blockchain.new_transaction(data['sender', data['amount'], data['recipient']])
