...
def mine():
    ...
    # We validate the proof send to us
    values = request.get_json()

    # Check tht thr required fields are in the POST'ed data
    required = ['proof']
...
def last_block_string():
   response = {
      #TODO: Return the chain and it's current length
